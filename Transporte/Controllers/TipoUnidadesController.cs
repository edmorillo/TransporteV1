...
namespace Transporte.Controllers
{
    public class TipoUnidadesController : Controller
    {
        ...
        public TipoUnidadesController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
            var tAI2Context = _context.TipoUnidades.Include(t => t.IdTipoMarcaUnidadesNavigation);
        ...
        {
            ViewData["IdTipoMarcaUnidades"] = new SelectList(_context.TipoMarcasUnidades, "IdTipoMarcaUnidad", "IdTipoMarcaUnidad");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoUnidad,Detalle,IdTipoMarcaUnidades")] TipoUnidade tipoUnidade)
        {
            ...
            ViewData["IdTipoMarcaUnidades"] = new SelectList(_context.TipoMarcasUnidades, "IdTipoMarcaUnidad", "IdTipoMarcaUnidad", tipoUnidade.IdTipoMarcaUnidades);
            return View(tipoUnidade);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.TipoUnidades'  is null.");
            }
            var tipoUnidade = await _context.TipoUnidades.FindAsync(id);
            if (tipoUnidade != null)
            {
