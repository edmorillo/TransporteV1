...
namespace Transporte.Controllers
{
    public class FormasPagoesController : Controller
    {
        ...
        public FormasPagoesController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
              return _context.FormasPagos != null ? 
                          View(await _context.FormasPagos.ToListAsync()) :
                          Problem("Entity set 'TAI2Context.FormasPagos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.FormasPagos'  is null.");
            }
            var formasPago = await _context.FormasPagos.FindAsync(id);
            if (formasPago != null)
            {
        ...
        {
          return (_context.FormasPagos?.Any(e => e.IdFormaPago == id)).GetValueOrDefault();
        }
    }
}
