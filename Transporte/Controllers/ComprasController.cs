...
namespace Transporte.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public ComprasController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
            var tAI2Context = _context.Compras.Include(c => c.IdFormaPagoNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.Compras'  is null.");
            }
            var compra = await _context.Compras.FindAsync(id);
            if (compra != null)
            {
