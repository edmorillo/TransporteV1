...
namespace Transporte.Controllers
{
    public class NeumaticoesController : Controller
    {
        ...
        public NeumaticoesController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
            var tAI2Context = _context.Neumaticos.Include(n => n.IdTipoMarcaNeumaticosNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.Neumaticos'  is null.");
            }
            var neumatico = await _context.Neumaticos.FindAsync(id);
            if (neumatico != null)
            {
