...
namespace Transporte.Controllers
{
    public class TdocumentoCsController : Controller
    {
        ...
        public TdocumentoCsController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
              return _context.TdocumentoCs != null ? 
                          View(await _context.TdocumentoCs.ToListAsync()) :
                          Problem("Entity set 'TAI2Context.TdocumentoCs'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.TdocumentoCs'  is null.");
            }
            var tdocumentoC = await _context.TdocumentoCs.FindAsync(id);
            if (tdocumentoC != null)
            {
        ...
        {
          return (_context.TdocumentoCs?.Any(e => e.IdTdocuC == id)).GetValueOrDefault();
        }
    }
}
