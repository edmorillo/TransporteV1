...
namespace Transporte.Controllers
{
    public class LicenciaChofersController : Controller
    {
        ...
        public LicenciaChofersController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
            var tAI2Context = _context.LicenciaChofers.Include(l => l.IdChoferNavigation).Include(l => l.IdTiposDocumentosNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.LicenciaChofers'  is null.");
            }
            var licenciaChofer = await _context.LicenciaChofers.FindAsync(id);
            if (licenciaChofer != null)
            {
        ...
        {
          return (_context.LicenciaChofers?.Any(e => e.IdLicenciaChofer == id)).GetValueOrDefault();
        }
    }
}
