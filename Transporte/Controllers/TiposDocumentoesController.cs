...
namespace Transporte.Controllers
{
    public class TiposDocumentoesController : Controller
    {
        ...
        public TiposDocumentoesController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
              return _context.TiposDocumentos != null ? 
                          View(await _context.TiposDocumentos.ToListAsync()) :
                          Problem("Entity set 'TAI2Context.TiposDocumentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.TiposDocumentos'  is null.");
            }
            var tiposDocumento = await _context.TiposDocumentos.FindAsync(id);
            if (tiposDocumento != null)
            {
        ...
        {
          return (_context.TiposDocumentos?.Any(e => e.IdTiposDocumentos == id)).GetValueOrDefault();
        }
    }
}
