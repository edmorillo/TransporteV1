...
namespace Transporte.Controllers
{
    public class TipoMarcasUnidadesController : Controller
    {
        ...
        public TipoMarcasUnidadesController(TAI2Context context)
        {
            _context = context;
        }
        ...
        {
              return _context.TipoMarcasUnidades != null ? 
                          View(await _context.TipoMarcasUnidades.ToListAsync()) :
                          Problem("Entity set 'TAI2Context.TipoMarcasUnidades'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TAI2Context.TipoMarcasUnidades'  is null.");
            }
            var tipoMarcasUnidade = await _context.TipoMarcasUnidades.FindAsync(id);
            if (tipoMarcasUnidade != null)
            {
        ...
        {
          return (_context.TipoMarcasUnidades?.Any(e => e.IdTipoMarcaUnidad == id)).GetValueOrDefault();
        }
    }
}
